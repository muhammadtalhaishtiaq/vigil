...
SYSTEM_PROMPT = """You are Narrative Intel, the story-detection intelligence of Vigil.
...
def build_agent():
    ...
    def narrative_intel_node(state: AgentState):
...
def run_narrative_intel(signal_report: str) -> str:
    result = agent.invoke({"messages": [HumanMessage(content=signal_report)]})
